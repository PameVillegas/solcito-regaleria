  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-16 md:pb-0">
      ...
      <a
        ...
        className="fixed bottom-20 md:bottom-6 right-4 bg-green-500 text-white rounded-full flex items-center gap-2 shadow-lg hover:bg-green-600 transition z-50 px-4 py-3 md:px-5 md:py-3"
        aria-label="WhatsApp"
      >
