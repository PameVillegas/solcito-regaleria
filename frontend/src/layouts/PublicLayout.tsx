...
export function PublicLayout() {
  ...
  return (
    <div className="min-h-screen bg-[#FDF6F0] pb-16 md:pb-0">
      ...
      {/* WhatsApp */}
      <a href="https://wa.me/542364274864?text=Hola%20Solcito%20Regalería!%20Quiero%20consultar%20por%20un%20producto" target="_blank" rel="noopener noreferrer"
        className="fixed bottom-20 md:bottom-6 right-4 bg-[#25D366] text-white rounded-full flex items-center gap-2 shadow-lg hover:bg-[#128C7E] transition z-50 px-4 py-3">
        ...
        <span className="font-medium text-sm">Consultanos</span>
      </a>
